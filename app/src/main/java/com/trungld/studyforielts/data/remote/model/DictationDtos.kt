...
data class DictationLessonDto(
    ...
    @SerializedName("level") val level: String,
    @SerializedName("contentType") val contentType: String = "dictation",
    @SerializedName("skill") val skill: String? = "listening",
    @SerializedName("cefrLevel") val cefrLevel: String? = null,
    @SerializedName("source") val source: String = "",
    @SerializedName("sourceUrl") val sourceUrl: String? = null,
    @SerializedName("licenseNote") val licenseNote: String? = null,
