...
function GrammarActivity({ onBack }: { onBack: () => void }) {
...
export default function App() {
  const [lessons, setLessons] = useState<Lesson[]>([]); const [selected, setSelected] = useState<Lesson | null>(null); const [review, setReview] = useState(false); const [grammar, setGrammar] = useState(false); const [error, setError] = useState(''); const [loading, setLoading] = useState(true);
